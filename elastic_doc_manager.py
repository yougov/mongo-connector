"""Receives documents from the oplog worker threads and indexes them
    ...
    This file is a document manager for the Elastic search engine, but the intent
...
class DocManager():
    """The DocManager class creates a connection to the backend engine and
        ...
        We are using elastic native fields for _id and ns, but we also store them as fields in the document, due to compatibility issues.
        """
    ...
    def commit(self):
        ...
        too many Elastic searchers, the commit is wrapped in a retry_until_ok to
