...
class SolrSimulator():
    """SolrSimulator emulates both a Solr DocManager and a Solr server.
    """
    ...
    def commit(self): 
        ...
        This function exists only because the DocManager is set to SolrSimulator, and the rollback
